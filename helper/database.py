...
class MongoDB:
    ...
    async def get_bot_settings(self, session_name: str):
        """Gets bot settings from the database."""
        return await self.bot_settings.find_one({'_id': session_name})

    async def update_bot_settings(self, session_name: str, settings: dict):
        """Updates bot settings in the database."""
